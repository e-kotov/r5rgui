...
This outlines how to propose a change to r5rgui. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("e-kotov/r5rgui", fork = TRUE)`.
...
Please note that the r5rgui project is released with a [Contributor Code
of Conduct](http://www.ekotov.pro/r5rgui/CODE_OF_CONDUCT.md). By
